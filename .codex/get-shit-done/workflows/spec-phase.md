...
```bash
INIT=$(node "/Users/promex04/Documents/NO/notch-app/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/promex04/Documents/NO/notch-app/.codex/get-shit-done/templates/spec.md.
