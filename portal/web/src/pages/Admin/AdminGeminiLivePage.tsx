...
export function AdminGeminiLivePage() {
  ...
  return (
    <div className="space-y-6 bg-[#f8f9fa] font-sans text-[#202124]">
      <div className="flex flex-col items-start justify-between gap-4 border-b border-[#dadce0] pb-4 sm:flex-row sm:items-center">
        ...
        <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded border border-[#1a73e8] bg-[#1a73e8] px-4 py-2 text-sm font-medium text-white hover:bg-[#1557b0] disabled:opacity-60 cursor-pointer"
          >
      ...
      {notice && (
        <div className="rounded border border-[#ceead6] bg-[#e6f4ea] p-4 text-sm font-medium text-[#137333]">
          {notice}
        </div>
      )}
      ...
      <div className="rounded border border-[#dadce0] bg-white p-4 shadow-sm">
        <div className="mb-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#5f6368]">Model ID nên khớp tên Gemini API, ví dụ gemini-2.5-flash-live-preview.</p>
          </div>
        </div>
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)_120px_auto]">
          <input
            ...
            className="rounded border border-[#dadce0] bg-white px-3 py-2 text-sm outline-none focus:border-[#1a73e8]"
                ...
                <tr key={model.id}>
                  ...
                  <td>
                    <input
                      ...
                      className="w-full rounded border border-[#dadce0] bg-white px-3 py-2 text-sm outline-none focus:border-[#1a73e8]"
                    />
                  </td>
                  <td>
                    <input
                      ...
                      className="w-24 rounded border border-[#dadce0] bg-white px-3 py-2 text-sm outline-none focus:border-[#1a73e8]"
                    />
                  </td>
                  <td>
                  ...
                  <td className="text-right">
                    <div className="inline-flex items-center gap-2">
                      <button
                        ...
                        disabled={savingKey === model.id}
                        className="inline-flex items-center gap-2 rounded border border-[#dadce0] bg-white px-3 py-2 text-sm font-medium text-[#1a73e8] hover:bg-[#f8f9fa] disabled:opacity-60 cursor-pointer"
                      >
                        <Save size={15} />
                        Lưu
                      </button>
                      <button
                        ...
                        disabled={savingKey === model.id}
                        className="inline-flex items-center gap-2 rounded border border-[#fad2cf] bg-white px-3 py-2 text-sm font-medium text-[#c5221f] hover:bg-[#fce8e6] disabled:opacity-60 cursor-pointer"
                      >
                        <Trash2 size={15} />
                        Xóa
                      </button>
