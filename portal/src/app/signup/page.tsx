    ...
    <div className="auth-container">
      <div className="auth-card glass">
        <div className="auth-header">
          ...
          <h1 className="auth-title">{accessToken ? 'Account created' : 'Create an account'}</h1>
          <p className="auth-subtitle">
            {accessToken
              ? 'Copy your access token and paste it into the Notch app.'
              : 'Create one account for both the Notch app and the web portal.'}
          </p>
        </div>
        ...
        {accessToken ? (
          <div className="success-container">
            ...
            <div className="token-info">
              <p className="instruction">Your account is ready</p>
              <p className="instruction-sub">Copy the token below and paste it into the Notch app.</p>
            </div>
          ...
          <>
            <div className="context-panel">
              ...
              <div className="context-copy">
                <p className="context-title">Start with your main account</p>
                <p className="context-text">After sign up, the access token is ready for the Notch app right away.</p>
              </div>
            </div>
