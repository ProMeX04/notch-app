...
- **Global scope**: `/Users/promex04/Documents/NO/notch-app/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/promex04/Documents/NO/notch-app/.codex/notes/`)
...
2. Glob `/Users/promex04/Documents/NO/notch-app/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/promex04/Documents/NO/notch-app/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/promex04/Documents/NO/notch-app/.codex/notes/` — works in any directory
