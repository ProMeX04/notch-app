...
INSTALL_JS_GLOBAL="/Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
