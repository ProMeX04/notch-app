...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-tools query`. Use `node /Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-tools query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node /Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```bash
node "/Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "/Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build snapshot \
  && node "/Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/bin/gsd-tools.cjs" graphify status
```
