...
```bash
INIT=$(node "/Users/promex04/Documents/NO/notch-app/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/promex04/Documents/NO/notch-app/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
