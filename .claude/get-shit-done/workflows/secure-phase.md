...
```
Agent(
  prompt="Read /Users/promex04/Documents/NO/notch-app/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/promex04/Documents/NO/notch-app/.claude/get-shit-done/templates/SECURITY.md`
